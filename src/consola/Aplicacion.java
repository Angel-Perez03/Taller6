...
public class Aplicacion {
    ...
    private void ejecutarOpcion3() throws ProductoTotal150 {
    ...
    private void ejecutarAgregarCombo() throws ProductoTotal150 {
    ...
    private void ejecutarAgregarProductoMenu() throws ProductoTotal150 {
        ArrayList<Producto> lista_productos = restaurante.getMenuBase();
        int j = 0;
        for (Producto i : lista_productos) {
            System.out.println((j + 1) + ". " + i.getNombre() + "|| $" + i.getPrecio() + " || cal: " + i.getCalorias());
            j++;
        }
    ...
    private void ejecutarAgregarBebida() throws ProductoTotal150 {
